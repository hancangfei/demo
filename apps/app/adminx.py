...
from .models import IDC, Host, MaintainLog, HostGroup, AccessRecord,DocSuggestionUnstructure
...
class GlobalSetting(object):
    site_title = '检察建议效果跟踪与评估系统'
    global_search_models = [Host, IDC, DocSuggestionUnstructure]
    global_models_icon = {
        Host: "fa fa-laptop", IDC: "fa fa-cloud", DocSuggestionUnstructure: "fa fa-laptop"
    }
